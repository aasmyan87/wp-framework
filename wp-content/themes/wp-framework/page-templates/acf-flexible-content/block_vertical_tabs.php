                    ...
                    <div class="col-md-9">
                        <div class="fw-tbv--tabs">
                            <?php $i = 0; while( have_rows('tabs') ): the_row(); ?>
                                ...
                                <div id="tab-<?php echo $i.'_'.$tab_id; ?>" class="fw-tbv--content <?php if( $i == 0 ){ echo 'active'; } ?>">
                                    <a class="fw-tbv--nav-mob acc-nav_js <?php if( $i == 0 ){ echo 'active'; } ?>" href="#">
                                        <span> <?php echo $tab_label; ?> </span>
                                        <i class="fw-tbv--ico icon-angle-down"></i>
